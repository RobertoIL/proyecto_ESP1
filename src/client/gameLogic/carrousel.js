export default class Carrousel{
    constructor(scene, x, y, button1Key, button2Key, lockButtonKey, characterKeys) {
        ...
        this.button1.on('pointerdown', function(){this.setTexture("Izquierda-Pulsada");});
        this.button1.on('pointerout', function(){this.setTexture("Boton-Izquierda");});

        this.button2.on('pointerup', this.nextCharacter, this);
        this.button2.on('pointerdown', function(){this.setTexture("Derecha-Pulsada");});
        this.button2.on('pointerout', function(){this.setTexture("Boton-Derecha");});
